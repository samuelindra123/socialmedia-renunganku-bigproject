...
export class MailService {
  ...
  async sendVerificationEmail(email: string, token: string, otp: string) {
                          ...
                          <table role="presentation" align="center" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="padding: 0 8px;">
                                <a href="https://renunganku.peakcenter.tech" style="color: #6B7280; text-decoration: none; font-size: 13px; font-weight: 500;">
                                  Website
                                </a>
                              </td>
                              <td style="padding: 0 4px; color: #D1D5DB; font-size: 13px;">•</td>
                              <td style="padding: 0 8px;">
                                <a href="mailto:support@renunganku.peakcenter.tech" style="color: #6B7280; text-decoration: none; font-size: 13px; font-weight: 500;">
                                  Bantuan
                                </a>
                              </td>
                              <td style="padding: 0 4px; color: #D1D5DB; font-size: 13px;">•</td>
                              <td style="padding: 0 8px;">
                                <a href="https://renunganku.peakcenter.tech/privacy" style="color: #6B7280; text-decoration: none; font-size: 13px; font-weight: 500;">
                                  Privasi
                                </a>
                              </td>
                            </tr>
    ...
    await this.resendService.send({
      from: 'Renunganku <noreply@renunganku.peakcenter.tech>',
      to: email,
...
---
© 2025 Renunganku
Website: https://renunganku.peakcenter.tech
Support: support@renunganku.peakcenter.tech
      `.trim(),
    });
  }
              ...
              <table role="presentation" width="100%" style="max-width:560px;background:#FFFFFF;border-radius:20px;border:1px solid #E5E7EB;padding:32px;">
                ...
                <tr>
                  <td>
                    ...
                    <p style="margin:32px 0 0;font-size:12px;color:#9CA3AF;text-align:center;">© ${new Date().getFullYear()} Renunganku • support@renunganku.peakcenter.tech</p>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" width="100%" style="max-width:560px;background:#020617;border-radius:24px;border:1px solid #1E293B;padding:28px 24px;box-shadow:0 24px 60px rgba(15,23,42,0.9);">
                ...
                <tr>
                  <td style="padding-top:12px;border-top:1px solid #1E293B;">
                    ...
                    <p style="margin:4px 0 0;font-size:11px;color:#4B5563;text-align:center;">© ${new Date().getFullYear()} Renunganku • support@renunganku.peakcenter.tech</p>
                  </td>
                </tr>
              </table>
            </td>
